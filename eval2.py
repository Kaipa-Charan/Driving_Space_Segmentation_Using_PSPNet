...
input_video_path = '/home/annotationguest/SegmentationDrivable/solidYellowLeft.mp4'  # Replace with the actual path to your input video
...
model.load_state_dict(torch.load('/home/annotationguest/SegmentationDrivable/PSPNet_driving_weights.pt', map_location=torch.device('cpu')))
model.eval()
