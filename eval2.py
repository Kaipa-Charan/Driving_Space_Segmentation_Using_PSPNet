...
input_video_path = 'ANY .MP4 INPUT VIDEO FILE'  # Replace with the actual path to your input video
...
model.load_state_dict(torch.load('PSPNet_driving_weights.pt', map_location=torch.device('cpu')))
model.eval()
